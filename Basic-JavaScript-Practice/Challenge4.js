...
let totalBalance = (tip === 0.2) ? (bill * 0.2) + bill : (bill * 0.15) + bill;

console.log(`your bill for ${bill} is: ${totalBalance}`);

bill = 40;
tip = (bill < 50) ? 0.0 : ((bill >= 50 && bill <= 300) ? 0.15 : 0.2);
totalBalance = (tip === 0.2) ? (bill * 0.2) + bill : ((bill === 0.15) ? (bill * 0.2) + bill : bill);

console.log(`your bill for ${bill} is: ${totalBalance}`);

bill = 430;
tip = (bill >= 50 && bill <= 300) ? 0.15 : 0.2;
totalBalance = (tip === 0.2) ? (bill * 0.2) + bill : (bill * 0.15) + bill;
